...
def is_symbol(india, juliett, number):
    if not (0 <= india < n and 0 <= juliett < m):
        return False

    if lines[india][juliett] == "*":
        goods[india][juliett].append(number)
    return lines[india][juliett] != "." and not lines[india][juliett].isdigit()
